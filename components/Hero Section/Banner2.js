...
function Banner2() {
  return (
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:flex gap-5  py-2">
      {data.map((item, index) => (
        <div className="flex overflow-hidden relative flex-col items-start py-9 pr-20 pl-5 text-xs font-bold tracking-tight w-full min-h-[220px]">
          <img
            loading="lazy"
            srcSet={item.image}
